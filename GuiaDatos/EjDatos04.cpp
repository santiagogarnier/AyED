...
// ordeno por urgencia y en caso de igualar, por cliente
...
void informarLista(Nodo<Requerimiento> *lista)
{
...
int main()
{
    ...
    Requerimiento req;
    fstream arch;
    arch.open("datos04.bin", ios ::in | ios::binary);
    if (!arch)
    {
    ...
    arch.close();
    cout << "Muestra del listado total: " << endl;
    mostrar(lista);
